...
export function getTools(): Tool[] {
  ...
  return [
    ...
    // ── Boston MCP (City of Boston open data) ────────────────
    //
    // Read-only access to:
    //   • 311 Service Requests (since 2011) — case type, neighborhood,
    //     status, SLA, department, coordinates, and more
    //   • MBTA transit data
    ...
    // │                                                         │
    // │  Function tool (self-hosted):                           │
    // │    { type: "function", name: "MyTool",                  │
    // │      description: "...", url, method: "POST",           │
    // │      timeout: 10, parameters: { ... } }                 │
    // │                                                         │
    // │  Platform tool (Subconscious-hosted):                   │
    // │    { type: "platform", id: "tool_id", options: {} }     │
    // └────────────────────────────────────────────────────────┘
  ];
}
